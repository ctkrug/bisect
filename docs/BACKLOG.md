...
- [ ] **Guess splits the bar and dims the losing half (WOW MOMENT)**
...
- [ ] **Win detection on a correct guess**
...
- [ ] **Guess counter with optimal-guess indicator**
...
- [ ] **Design polish: board matches DESIGN.md blueprint tokens**
...
- [ ] **Level select and progress persisted in localStorage**
...
- [ ] **Design polish: level-select and transitions match DESIGN.md**
...
- [ ] **Tweened split/dim animation with impact feedback**
...
- [ ] **Synth SFX suite with persisted mute toggle**
...
- [ ] **Win celebration overlay with run stats**
...
- [ ] **Design polish: juice motion and timing match the DESIGN.md plan**
...
- [ ] **Responsive layout at 390/768/1440 with touch controls**
...
- [ ] **Accessibility: focus states, live status, and reduced motion**
...
- [ ] **Design polish: brand assets and final self-review**
